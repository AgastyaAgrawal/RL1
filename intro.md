...
A large focus of this project was the developement of completely modular code, maintaing a very high level of abstraction. This was done primarily to practice and develop the skills required to build production level code, which is helpful when building experiments that matter and are going ot be reused.
